...
export class VariableWhere {
  ...
  @Field(() => BASE_STRING_FILTER, { description: VariableDescription.Source, nullable: true })
  @IsOptional()
  source?: StringFilter;

  @Field(() => BASE_JSON_FILTER, { description: VariableDescription.Value, nullable: true })
  @IsOptional()
  value?: JsonFilter;
